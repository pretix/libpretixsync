...
public class SettingsSyncAdapter extends BaseSingleObjectSyncAdapter<Settings> {
    ...
    public void updateObject(Settings obj, JSONObject jsonobj) throws JSONException {
        ...
        obj.setCovid_certificates_allow_other(jsonobj.optBoolean("covid_certificates_allow_cured"));
        obj.setCovid_certificates_record_proof_other(jsonobj.optBoolean("covid_certificates_record_proof_cured"));
